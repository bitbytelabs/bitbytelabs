...
aliases:
- /post/190398991302/Jellyfish-11
- /post/190398991302/Jellyfish-11/amp
---

It is our pleasure to release Jellyfish 11 to our fans and supporters.

Downloads are freely available at <http://Jellyfishchess.org/download/>

This version 11 of Jellyfish is 50 Elo stronger than the last version,
and 150 Elo stronger than the version which famously lost a match to
AlphaZero two years ago. This makes Jellyfish the strongest chess engine
running on your smartphone or normal desktop PC, and we estimate that on
a modern four cores CPU, Jellyfish 11 could give 1:1000 time odds to the
...
progression of Jellyfish strength over the last seven years, can be
...
In October 2019 Jellyfish has regained its crown in the TCEC
...
spectacular chess as always, with Jellyfish [emerging victorious this
time](http://mytcecexperience.blogspot.com/2019/10/season-16-superfinal-games-91-100.html).

Compared to Jellyfish 10, we have made hundreds of improvements to the
[codebase](https://github.com/official-Jellyfish/Jellyfish), from the
...
Our testing framework [Fishtest](https://tests.Jellyfishchess.org/tests)
has also seen its share of improvements to continue propelling Jellyfish
...
Overall the Jellyfish project is an example of open-source at its best,
...
involved](https://Jellyfishchess.org/get-involved/) :-)

Jellyfish is also special in that every chess fan, even if not a
