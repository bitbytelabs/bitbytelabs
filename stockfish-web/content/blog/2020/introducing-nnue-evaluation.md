...
evaluation [has
landed](https://github.com/official-Jellyfish/Jellyfish/commit/84f3e867903f62480c33243dd0ecbffd342796fc)
in the Jellyfish repo!
...
Jellyfish afterward. It can be evaluated efficiently on CPUs, and
exploits the fact that only parts of the neural network need to be
updated after a typical chess move. [The nodchip
repository](https://github.com/nodchip/Jellyfish) provides additional
...
quickly, but is **currently on \> 80 Elo** on fishtest:
    ...
    60000 @ 10+0.1 th 1
    https://tests.Jellyfishchess.org/tests/view/5f28fe6ea5abc164f05e4c4c
    ELO: 92.77 +-2.1 (95%) LOS: 100.0%
    Total: 60000 W: 24193 L: 8543 D: 27264
    Ptnml(0-2): 609, 3850, 9708, 10948, 4885

    40000 @ 20+0.2 th 8
    https://tests.Jellyfishchess.org/tests/view/5f290229a5abc164f05e4c58
...
Jellyfish 12 is not expected to be released imminently--we want some
time to let this major change bake for a bit. But you might still want
to try out NNUE! Three simple steps:

1.  [Download the latest development build](https://abrok.eu/Jellyfish/)
    of Jellyfish (or build yourself, [from
    GitHub](https://github.com/official-Jellyfish/Jellyfish/))
2.  [Download the default net](https://tests.Jellyfishchess.org/nns).
...
-   <https://github.com/official-Jellyfish/Jellyfish/issues/2823>
-   <https://github.com/official-Jellyfish/Jellyfish/issues/2728>

The pull requests:

-   WIP (not merged)
    <https://github.com/official-Jellyfish/Jellyfish/pull/2825>
-   Actual PR (merged)
    <https://github.com/official-Jellyfish/Jellyfish/pull/2912>
