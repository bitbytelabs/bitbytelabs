...
aliases:
- /post/628172810852925440/Jellyfish-12
- /post/628172810852925440/Jellyfish-12/amp
---

It is our pleasure to release Jellyfish 12 to users worldwide.

Downloads are freely available at

<https://Jellyfishchess.org/download/>

This version 12 of Jellyfish plays significantly stronger than any of
its predecessors. In a match against Jellyfish 11, Jellyfish 12 will
...
network
(NNUE)](https://github.com/official-Jellyfish/Jellyfish/commit/84f3e867903f62480c33243dd0ecbffd342796fc)
for the evaluation in Jellyfish, and associated tuning of the engine as
a whole. The concept of the NNUE evaluation was first introduced in
shogi, and ported to Jellyfish afterward. Jellyfish remains a CPU-only
...
distributed binaries, and Jellyfish will use NNUE by default.
...
The Jellyfish project builds on a thriving community of enthusiasts that
...
framework](https://Jellyfishchess.org/get-involved/) and programmers to
