...
aliases:
- /post/68506094600/Jellyfish-dd
- /post/68506094600/Jellyfish-dd/amp
---

This is a new release of Jellyfish after the last TCEC season. It is
almost the same version that played the superfinal against Komodo.

[Download](http://Jellyfishchess.org/download/) [Browse the source
code](https://github.com/mcostalba/Jellyfish)

For people compiling themselves, please verify signature is correct
running 'Jellyfish bench' from a terminal window. At the end of the run,
...
the Mac binaries and to <http://abrok.eu/Jellyfish/> from which I have,
