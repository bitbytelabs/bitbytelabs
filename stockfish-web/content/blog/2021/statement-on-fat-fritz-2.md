...
Jellyfish is an open-source project, sharing and freely distributing the
...
users. The recent progress in playing strength of Jellyfish confirms the
path taken. We proudly provide the tools for free chess analysis to
millions of users, with countless titled players using Jellyfish for
...
2 chess engine. This chess engine is a Jellyfish derivative, with a few
...
Selling Jellyfish derivatives is possible with the GPLv3 license we
...
---Joost VandeVondele, current maintainer of the Jellyfish project
