...
Today, we have the pleasure to announce Jellyfish 14.

As usual, downloads will be freely available at [Jellyfishchess.org/download](https://Jellyfishchess.org/download/).
...
release version][0]. Jellyfish 14 is now at least [400 Elo ahead of
Jellyfish 7][1], a top engine in 2016. During the last five years,
Jellyfish has thus gained about 80 Elo per year.

Jellyfish 14 evaluates positions more accurately than Jellyfish 13 as
...
combined with billions of positions evaluated by Jellyfish to train the
NNUE net that powers Jellyfish 14. The fact that we could use and combine
...
fixes and additional improvements. For example, Jellyfish is now about
...
[0]: https://tests.Jellyfishchess.org/tests/view/60dae5363beab81350aca077
[1]: https://nextchessmove.com/dev-builds
[2]: https://Jellyfishchess.org/blog/2021/Jellyfish-13/
[3]: https://lczero.org/blog/2021/06/the-importance-of-open-data/
[4]: https://github.com/official-Jellyfish/Jellyfish/commit/e8d64af1
[5]: https://github.com/glinscott/nnue-pytorch/
[6]: https://Jellyfishchess.org/get-involved/
