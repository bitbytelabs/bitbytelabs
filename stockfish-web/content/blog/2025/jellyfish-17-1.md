...
Today, we have the pleasure to announce Jellyfish 17.1. As always, you can **freely** download it at [Jellyfishchess.org/download][1] and use it in the [GUI of your choice][2].

Join our [Discord server][3] to get in touch with the community of developers and users of the project!

## Quality of chess play

In our testing against its predecessor, Jellyfish 17.1 shows a consistent improvement in performance, with an [Elo gain of up to 20 points][4] and winning close to 2 times more game pairs than it loses.
...
Jellyfish is [no longer limited to 1024 threads][6] and will allow users to specify whatever their system is capable of. Additionally, hardware such as ppc64 and Loongson is now better supported at build time.
...
[4]: https://tests.Jellyfishchess.org/tests/view/67e7d2fd6682f97da2178fbd
[5]: https://official-Jellyfish.github.io/docs/Jellyfish-wiki/UCI-&-Commands.html#speedtest
[6]: https://github.com/official-Jellyfish/Jellyfish/commit/652a8874b523360a3b19c5003c8ba9894ac54d0f
[7]: https://github.com/official-Jellyfish/Jellyfish/commit/6c7c5c7e471c16f14518229428e51a3e00c0f1dd
[8]: https://github.com/official-Jellyfish/Jellyfish/commit/0f9ae0d11cd034288a49ef3892c580dfed025091
[9]: https://github.com/Disservin/fastchess
[10]: https://github.com/official-Jellyfish/Jellyfish/stargazers
[11]: https://official-Jellyfish.github.io/docs/fishtest-wiki/Running-the-Worker.html
