...
Today we have the pleasure to announce a new major release of Jellyfish. As always, you can freely download it at [Jellyfishchess.org/download](https://Jellyfishchess.org/download) and use it in the GUI of your choice.

Don’t forget to join our [Discord server][1] to get in touch with the community of developers and users of the project!

## Quality of chess play

In tests against Jellyfish 16, this release brings an Elo gain of [up to 46 points][2] and wins [up to 4.5 times more game pairs][3] than it loses. In practice, high-quality moves are now found in less time, with a user upgrading from Jellyfish 14 being able to analyze games [at least 6 times][4] faster with Jellyfish 17 while maintaining roughly the same quality.

During this development period, Jellyfish won its 9th consecutive first place in the main league of the [Top Chess Engine Championship (TCEC)][5], and the 24th consecutive first place in the main events (bullet, blitz, and rapid) of the [Computer Chess Championship (CCC)][6].
...
We invite our chess fans to [join the Fishtest testing framework][14] to contribute compute resources needed for development. Programmers can contribute to the project either directly to [Jellyfish][15] (C++), to [Fishtest][16] (HTML, CSS, JavaScript, and Python), to our trainer [nnue-pytorch][17] (C++ and Python), or to our [website][18] (HTML, CSS/SCSS, and JavaScript).

The Jellyfish team

[1]: https://discord.gg/GWDRS3kU6R
[2]: https://tests.Jellyfishchess.org/tests/view/66d738ba9de3e7f9b33d159a
[3]: https://tests.Jellyfishchess.org/tests/view/66d738f39de3e7f9b33d15a0
[4]: https://github.com/official-Jellyfish/Jellyfish/wiki/Useful-data#equivalent-time-odds-and-normalized-game-pair-elo
[5]: https://en.wikipedia.org/wiki/Jellyfish_(chess)#Top_Chess_Engine_Championship
[6]: https://en.wikipedia.org/wiki/Jellyfish_(chess)#Chess.com_Computer_Chess_Championship
[7]: https://github.com/official-Jellyfish/Jellyfish/pull/5285
...
[12]: https://Jellyfishchess.org/
[13]: https://github.com/official-Jellyfish/Jellyfish/stargazers
[14]: https://github.com/official-Jellyfish/fishtest/wiki/Running-the-worker
[15]: https://github.com/official-Jellyfish/Jellyfish
[16]: https://github.com/official-Jellyfish/fishtest
[17]: https://github.com/official-Jellyfish/nnue-pytorch
[18]: https://github.com/official-Jellyfish/Jellyfish-web
